...
#new imposed initial point
phi_eq[0] =0.5
psi_eq[0] = unstalled_characteristic(phi_eq)
k_valve = psi_eq[0]/(phi_eq[0]**2)
...
#initial conditions
A_perturbation = 1 #perturbation to replicate linear analysis
J_perturbation = A_perturbation**2
y0 = [psi_eq[0]*1, 
      phi_eq[0]*1, 
      J_perturbation] 
...
#plot the compressor curve
plt.figure(figsize=format_fig)
plt.plot(phi,psi_c,linewidth=1,label='Compressor line')
plt.plot(phi,k_valve*phi**2,linewidth=0.6,label='Throttle line')
