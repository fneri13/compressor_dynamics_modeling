...
n = 2
Dict = {}
x = np.linspace(-np.pi/3,np.pi/3,1000) #x plays the role of the beta2 variable
for ii in range(0,len(x)):
    Dict[x[ii]] = Bimp_n(s, n, Vx1, Vr2, Vy1, Vy2, alfa1, beta1, x[ii], r1, r2, rho1, rho2, A1, A2, s_i, dLi_dTanb)
    
fig, axes = plt.subplots(3,3, figsize=format_fig)
fig.suptitle('Bimp, s='+str(s.real)+'+'+str(s.imag)+'j')
axes[0,0].set_ylabel(r'$B_{imp_{11}}$')
axes[0,1].set_ylabel(r'$B_{imp_{12}}$')
axes[0,2].set_ylabel(r'$B_{imp_{13}}$')
axes[1,0].set_ylabel(r'$B_{imp_{21}}$')
axes[1,1].set_ylabel(r'$B_{imp_{22}}$')
axes[1,2].set_ylabel(r'$B_{imp_{23}}$')
axes[2,0].set_ylabel(r'$B_{imp_{31}}$')
axes[2,1].set_ylabel(r'$B_{imp_{32}}$')
axes[2,2].set_ylabel(r'$B_{imp_{33}}$')
...
axes[2,0].set_xlabel(r'$\beta_{2}$')
axes[2,1].set_xlabel(r'$\beta_{2}$')
axes[2,2].set_xlabel(r'$\beta_{2}$')
fig.legend()
fig.savefig(path+'/Bimp.png')
...
n = 2
Dict = {}
x = np.linspace(-np.pi/3,np.pi/3,1000) #x plays the role of the alpha2 variable
for ii in range(0,len(x)):
    Dict[x[ii]] = Bdif_n(s, n, Vr1, Vr2, Vy1, Vy2, alfa1, beta1, x[ii], r1, r2, rho1, rho2, A1, A2, s_dif, dLd_dTana)
    
fig, axes = plt.subplots(3,3, figsize=format_fig)
fig.suptitle('Bdif, s='+str(s.real)+'+'+str(s.imag)+'j')
axes[0,0].set_ylabel(r'$B_{dif_{11}}$')
axes[0,1].set_ylabel(r'$B_{dif_{12}}$')
axes[0,2].set_ylabel(r'$B_{dif_{13}}$')
axes[1,0].set_ylabel(r'$B_{dif_{21}}$')
axes[1,1].set_ylabel(r'$B_{dif_{22}}$')
axes[1,2].set_ylabel(r'$B_{dif_{23}}$')
axes[2,0].set_ylabel(r'$B_{dif_{31}}$')
axes[2,1].set_ylabel(r'$B_{dif_{32}}$')
axes[2,2].set_ylabel(r'$B_{dif_{33}}$')
T11 = np.zeros(len(x), dtype = complex)
T12 = np.zeros(len(x), dtype = complex)
T13 = np.zeros(len(x), dtype = complex)
T21 = np.zeros(len(x), dtype = complex)
...
axes[2,2].plot(x, T33.real)
axes[2,2].plot(x, T33.imag)
axes[2,0].set_xlabel(r'$\alpha_{2}$')
axes[2,1].set_xlabel(r'$\alpha_{2}$')
axes[2,2].set_xlabel(r'$\alpha_{2}$')
fig.legend()
fig.savefig(path+'/Bdif.png')
