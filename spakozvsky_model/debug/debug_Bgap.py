...
for ii in range(0,len(x)):
    Dict[x[ii]] = Bgap_n(x1, x1 + x[ii], s, n, Vx, Vy)
    
fig, axes = plt.subplots(3,3, figsize=format_fig)
fig.suptitle('Bgap')
axes[0,0].set_ylabel(r'$B_{gap_{11}}$')
axes[0,1].set_ylabel(r'$B_{gap_{12}}$')
axes[0,2].set_ylabel(r'$B_{gap_{13}}$')
axes[1,0].set_ylabel(r'$B_{gap_{21}}$')
axes[1,1].set_ylabel(r'$B_{gap_{22}}$')
axes[1,2].set_ylabel(r'$B_{gap_{23}}$')
axes[2,0].set_ylabel(r'$B_{gap_{31}}$')
axes[2,1].set_ylabel(r'$B_{gap_{32}}$')
axes[2,2].set_ylabel(r'$B_{gap_{33}}$')
