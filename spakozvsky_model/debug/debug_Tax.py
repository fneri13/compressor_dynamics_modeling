...
for ii in range(0,len(x)):
    Dict[x[ii]] = Tax_n(x[ii], s, n, Vx, Vy)
    
fig, axes = plt.subplots(3,3, figsize=format_fig)
fig.suptitle('Tax, s='+str(s.real)+'+'+str(s.imag)+'j')
axes[0,0].set_ylabel(r'$T_{ax_{11}}$')
axes[0,1].set_ylabel(r'$T_{ax_{12}}$')
axes[0,2].set_ylabel(r'$T_{ax_{13}}$')
axes[1,0].set_ylabel(r'$T_{ax_{21}}$')
axes[1,1].set_ylabel(r'$T_{ax_{22}}$')
axes[1,2].set_ylabel(r'$T_{ax_{23}}$')
axes[2,0].set_ylabel(r'$T_{ax_{31}}$')
axes[2,1].set_ylabel(r'$T_{ax_{32}}$')
axes[2,2].set_ylabel(r'$T_{ax_{33}}$')
