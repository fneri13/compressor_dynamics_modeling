...
for ii in range(0,len(x)):
    Dict[x[ii]] = Trad_n(x[ii], R2, n, s, Q, GAMMA)
    
fig, axes = plt.subplots(3,3, figsize=format_fig)
fig.suptitle('Trad')
axes[0,0].set_ylabel(r'$T_{rad_{11}}$')
axes[0,1].set_ylabel(r'$T_{rad_{12}}$')
axes[0,2].set_ylabel(r'$T_{rad_{13}}$')
axes[1,0].set_ylabel(r'$T_{rad_{21}}$')
axes[1,1].set_ylabel(r'$T_{rad_{22}}$')
axes[1,2].set_ylabel(r'$T_{rad_{23}}$')
axes[2,0].set_ylabel(r'$T_{rad_{31}}$')
axes[2,1].set_ylabel(r'$T_{rad_{32}}$')
axes[2,2].set_ylabel(r'$T_{rad_{33}}$')
